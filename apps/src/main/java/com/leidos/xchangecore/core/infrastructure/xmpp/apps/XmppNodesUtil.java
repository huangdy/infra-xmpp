...
public class XmppNodesUtil {
    ...
    synchronized private static ApplicationContext initContext(String contextFile) {
        ...
        String localContextFile = "./" + contextFile;
    ...
    public static void main(String[] args) {
        ...
        ApplicationContext context = initContext(ContextFile);

        XmppNodesUtil util = (XmppNodesUtil) context.getBean("util");
        ...
        if (args[0].equals(CleanupNodesCommand)) {
            ...
            List<String> nodeList = util.getCoreXMPPUtils().getAllNodesRecursivly();
